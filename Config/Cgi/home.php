    ...
    <div class=wra>
        <form>  
            ...
            <!-- <a href="home.php" br><input type="submit" value="Home"> >Go Home</a> -->
				...
				<?php 
				if (!isset($_COOKIE['cgi']))
                    echo '<input type="button"  class="button_active" onclick="location.href=\'login1.php\';" value="Login"/>';

					// echo '<a href="login1.php" class="button_active">Login</a>';
				else
                    echo '<input type="button"  class="button_active" onclick="location.href=\'home1.php\';" value="Home"/> ';

                // echo '<a href="home1.php?path=logout" class="button_active">Logout</a>';
				?>
